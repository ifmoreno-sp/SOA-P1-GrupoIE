...
# variantes de sanitizer (ver docs/casos_enunciado.md y
# entorno_desarrollo.md del repo de conocimiento sobre por que ASan+LSan
# necesita Docker/Linux y TSan necesita macOS nativo en este entorno).
#
