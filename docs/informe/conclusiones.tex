...
extensión no está activa. El experimento A/B (Sección~\ref{sec:resultados-extension})
confirma que la tarea comparada recupera una fracción sustancial y
estadísticamente significativa de la participación a la que tenía derecho
(mejora relativa $+63.67\%$, IC 95\% $[58.4\%, 68.9\%]$ sobre 100 semillas),
efecto robusto en dirección pero sensible en magnitud al tamaño de la
ventana de observación y a los demás parámetros del experimento.
