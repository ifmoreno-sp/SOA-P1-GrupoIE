...
extensión de compensación (Sección~\ref{sec:resultados-extension}): la
misma dirección del efecto se sostiene entre 15 y 55 despachos, pero su
magnitud reportada varía de $+3.3\%$ a $+69.4\%$ según la ventana elegida,
y por debajo de $\sim 15$ despachos la métrica de mejora se vuelve
matemáticamente inestable.
